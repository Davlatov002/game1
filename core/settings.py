...
SECRET_KEY = 'django-insecure-6qyu@+i1u4yg)u^&7r1xi2hf98dlzob5d&c@4*f&zc=9)&7o*m'
...
CORS_ALLOWED_ORIGINS = [
    'http://13.60.23.197',
    'http://13.60.23.197:8000',
    'https://mb-game.netlify.app',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gamedb',        # Ma'lumotlar bazasining nomi
